import QuestionDollars # this import the Question file to allow Unrecognised to access it
...
def main(): # uses the integer input as user should only input a whole number
   ...
   Selection unrecognised, would you like to continue?
    ...
    if choice == 1:
        QuestionDollars.question() # if the user inputs exactly the number 1 it will lead to the question section
